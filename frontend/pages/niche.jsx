...
export default function Niche(){
  ...
  async function find() {
    ...
    const body = { seed: seedEl?.value || '', region: regionEl?.value || 'UK' };
  ...
  return (
    <div style={{padding:24, fontFamily:'system-ui'}}>
      ...
      <p style={{opacity:.8, marginTop:12}}>Backend: <code>{process.env.NEXT_PUBLIC_API_BASE || '(not set: Vercel → Env Vars)'}</code></p>
    </div>
  );
}
