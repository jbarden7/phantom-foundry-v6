export default function Home(){
  ...
  return (
    <main style={{maxWidth:960,margin:'0 auto',padding:24,fontFamily:'system-ui'}}>
      ...
      <p>{demo ? 'Demo Mode is ON (safe, no real uploads).' : 'Live Mode. Draft-only is recommended.'}</p>
      <p>API Base: <code>{api}</code></p>
      <ul>
        <li><a href="/niche">Niche Finder</a></li>
        <li><a href="/prompts">AI Prompt Engine</a></li>
        <li><a href="/uploads">Uploads</a></li>
        <li><a href="/compliance">Compliance Preview</a></li>
